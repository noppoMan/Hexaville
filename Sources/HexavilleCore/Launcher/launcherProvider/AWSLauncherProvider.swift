...
extension AWSLauncherProvider {
    ...
    func sourceARN(region: Region, lambdaURI: String, restApiId: String, httpMethod: String, path: String) throws -> String {
    ...
    func lambdaURI(region: Region, arn: String) -> String {
