...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/swift-aws/s3.git", .upToNextMajor(from: "1.0.1")),
        .package(url: "https://github.com/swift-aws/lambda.git", .upToNextMajor(from: "1.0.1")),
        .package(url: "https://github.com/swift-aws/iam.git", .upToNextMajor(from: "1.0.1")),
        .package(url: "https://github.com/swift-aws/apigateway.git", .upToNextMajor(from: "1.0.1")),
